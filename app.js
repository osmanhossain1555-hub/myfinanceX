...
function bindEvents() {
  [els.openEntryBtn, els.bottomAddBtn].forEach(btn => btn?.addEventListener('click', () => openDialog(els.entryDialog)));
  els.openBillBtn?.addEventListener('click', () => openDialog(els.billDialog));
  els.openGoalBtn?.addEventListener('click', () => openDialog(els.goalDialog));
  els.cancelEntry?.addEventListener('click', () => closeDialog(els.entryDialog));
  els.cancelBill?.addEventListener('click', () => closeDialog(els.billDialog));
  els.cancelGoal?.addEventListener('click', () => closeDialog(els.goalDialog));
